...
@section('content')
    ...
    <section class="feat-section">
        <div class="container">
            <div class="feat-header wow fadeInUp" data-wow-delay="0.1s">
                <span class="feat-eyebrow">✦ Our Promise ✦</span>
                <h2 class="feat-title">What Makes Us <span>Different</span></h2>
            </div>
            <div class="feat-grid">

                <div class="feat-card wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feat-icon-box">
                        <i class="fas fa-award"></i>
                    </div>
                    <h5 class="feat-name">Ijazah Certified</h5>
                    <p class="feat-desc">Every teacher holds a certified chain of Quranic transmission — guaranteed
                        authenticity.</p>
                </div>
                ...
                <div class="feat-card wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <h5 class="feat-name">Female Teachers</h5>
                    <p class="feat-desc">Qualified Ustazahs available for sisters and young girls in a fully safe
                        environment.</p>
                </div>

                <div class="feat-card wow fadeInUp" data-wow-delay="0.3s">
                    <div class="feat-icon-box">
                        <i class="fas fa-clock"></i>
                    </div>
                    <h5 class="feat-name">Flexible Timings</h5>
                    <p class="feat-desc">Classes available Mon–Sat, 6PM–4AM. We accommodate UK, USA & Pakistan time zones.
                    </p>
                </div>

                <div class="feat-card wow fadeInUp" data-wow-delay="0.4s">
                    <div class="feat-icon-box">
                        <i class="fas fa-certificate"></i>
                    </div>
                    <h5 class="feat-name">Official Certificate</h5>
                    <p class="feat-desc">Receive an academy certificate upon course completion — recognised and valued
                        globally.</p>
                </div>
