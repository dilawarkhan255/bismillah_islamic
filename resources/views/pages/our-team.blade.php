            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="display-6 text-white mb-3">
                        {!! section('our-team', 'cta', 'title', 'Learn From The <span style="color:var(--gold-light);">Best Scholars</span>') !!}
                    </h1>
                    <p class="mb-0" style="color:rgba(255,255,255,0.65); font-size:16px; max-width:580px;">
                        {{ section('our-team', 'cta', 'description', 'Enroll today and study under our qualified teachers — dedicated to guiding every student on the path of Quran and Sunnah.') }}
                    </p>
                </div>
                <div class="col-lg-4 text-lg-end wow fadeInUp" data-wow-delay="0.3s">
                    <a href="{{ section('our-team', 'cta', 'button_url', '/contact') }}" class="btn rounded-pill py-3 px-5 me-3 mb-3"
                        style="background:var(--gold);color:#fff;border:none;">{{ section('our-team', 'cta', 'button_text', 'Enroll Now') }}</a>
