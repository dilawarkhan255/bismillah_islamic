...
@push('styles')
    ...
    .bia-plan-featured:hover { transform: translateY(-14px); }
    .bia-col-popular { z-index: 3; }
    ...
    .bia-cta-wa:hover { background: #25D366; color: #fff; }
    .bia-cta-wa i { font-size: 14px; }

    /* ─── TABLE ────────────────────────────────────────── */
    .bia-table { width: 100%; border-collapse: collapse; min-width: 460px; }
    .bia-table thead tr { background: rgba(174,130,37,.1); }
    .bia-table th {
        font-family: 'Cinzel', serif;
        font-size: 12px;
        font-weight: 700;
    ...
    .bia-th-feat { text-align: left; color: rgba(255,255,255,.5); font-size: 10px; letter-spacing: 1.5px; }
    .bia-th-b { background: rgba(174,130,37,.08); }
    .bia-table tbody tr { border-bottom: 1px solid rgba(255,255,255,.04); transition: background .2s; }
    .bia-table tbody tr:hover { background: rgba(255,255,255,.03); }
    .bia-table td { padding: 12px 20px; text-align: center; }
    .bia-td-lbl { text-align: left; font-family: 'Lato', sans-serif; font-size: 13px; color: rgba(255,255,255,.8); font-weight: 600; }
    .bia-td-b { background: rgba(174,130,37,.05); }
    ...
    @media(max-width:991px) {
        .bia-plan-featured { transform: none; }
        .bia-plan-featured:hover { transform: translateY(-8px); }
        .bia-plan:hover { transform: translateY(-5px); }
    }
    @media(max-width:575px) {
        .bia-plan-letter { font-size: 40px; }
        .bia-day-dot { width: 28px; height: 28px; font-size: 9px; }
        .bia-stats-strip { flex-wrap: wrap; }
        .bia-stat { padding: 10px 6px; }
        .bia-stat-val { font-size: 11px; }
    }
    </style>
@endpush
