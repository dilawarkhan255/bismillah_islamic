        ...
        <form action="{{ route('admin.pricing.update', $plan) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="badge" id="badge" class="form-control" value="{{ old('badge', $plan->badge) }}">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="color" name="accent_color" id="accent_color" class="form-control form-control-color" value="{{ old('accent_color', $plan->accent_color ?? '#4e73df') }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="days_per_week" id="days_per_week" class="form-control" value="{{ old('days_per_week', $plan->days_per_week) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="classes_per_month" id="classes_per_month" class="form-control" value="{{ old('classes_per_month', $plan->classes_per_month) }}">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="courses_count" id="courses_count" class="form-control" value="{{ old('courses_count', $plan->courses_count) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="report_frequency" id="report_frequency" class="form-control" value="{{ old('report_frequency', $plan->report_frequency) }}">
                ...
                <div class="col-md-4 mb-3 d-flex align-items-end gap-3">
                    <div class="form-check">
                        <input type="checkbox" name="certificate" id="certificate" class="form-check-input" value="1" {{ old('certificate', $plan->certificate) ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <div id="features-container">
                    @if(old('features', $plan->features))
                        ...
                        @endforeach
                    @endif
                    @if(empty(old('features')) && empty($plan->features))
                        <div class="input-group mb-2">
