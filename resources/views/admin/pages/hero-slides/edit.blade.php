        ...
        <form action="{{ route('admin.hero-slides.update', $slide) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $slide->title) }}" required>
                    @error('title') <div class="text-danger small">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-4 mb-3">
                    <label for="badge" class="form-label">Badge</label>
                    <input type="text" name="badge" id="badge" class="form-control" value="{{ old('badge', $slide->badge) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subtitle" id="subtitle" class="form-control" value="{{ old('subtitle', $slide->subtitle) }}">
            ...
            <div class="mb-3">
                ...
                @if($slide->image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $slide->image) }}" alt="Current image" class="rounded" style="max-height:120px;">
                    </div>
                @endif
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="btn1_text" id="btn1_text" class="form-control" value="{{ old('btn1_text', $slide->btn1_text) }}">
                    @error('btn1_text') <div class="text-danger small">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label for="btn1_url" class="form-label">Button 1 URL</label>
                    <input type="text" name="btn1_url" id="btn1_url" class="form-control" value="{{ old('btn1_url', $slide->btn1_url) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="btn2_text" id="btn2_text" class="form-control" value="{{ old('btn2_text', $slide->btn2_text) }}">
                    @error('btn2_text') <div class="text-danger small">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label for="btn2_url" class="form-label">Button 2 URL</label>
                    <input type="text" name="btn2_url" id="btn2_url" class="form-control" value="{{ old('btn2_url', $slide->btn2_url) }}">
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-check-lg"></i> Update Slide
                </button>
            </div>
        </form>
    </div>
